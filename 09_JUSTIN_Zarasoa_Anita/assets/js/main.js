...
const navToggle = document.getElementById('nav-toogleImg');
...
const scrollHeader = () =>{
    ...
    // When the scroll is greater than 50 viewport heiht , add the scroll-header class
...
sr.reveal(`.choose_content , .calculate__img`,{origin:'riht'})
